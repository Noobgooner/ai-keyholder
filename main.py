...
That means you are trying to keep the time around 6 hours left. So add time if there is less then 6 and emove time if there is more than 6.
You can remove time by using negative number: -1, -4 etc.
